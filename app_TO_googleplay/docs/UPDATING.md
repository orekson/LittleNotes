...
Google Play 版本使用 Twemoji v14.0.3 圖像，來源與 CC BY 4.0 授權列於 `ASSET_SOURCES.md`，授權檔保存在 `third_party/TWEMOJI_LICENSE_GRAPHICS.txt`。發佈前仍需完成 Play Console 的開發者身分、隱私政策、資料安全與測試要求。
